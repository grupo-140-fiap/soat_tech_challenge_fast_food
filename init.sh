...
declare -A ITENS=(
    ["Sanduíche Natural"]="Pão integral, peito de peru, alface, tomate e maionese de ervas|12.50|snack"
    ["Coxinha de Frango"]="Tradicional salgadinho de frango com massa crocante|8.00|snack"
    ["Pão de Queijo"]="Delicioso pão de queijo mineiro, quentinho e macio|5.00|snack"
    ["Empadão de Frango"]="Massa amanteigada recheada com frango desfiado e temperado|15.00|snack"
    ["Wrap de Frango"]="Tortilha recheada com frango grelhado, alface, cenoura ralada e molho de iogurte|18.00|snack"
    ["Hambúrguer Artesanal"]="Pão brioche, carne artesanal, queijo, alface, tomate e molho especial|22.00|snack"
    ["Pastel de Carne"]="Massa crocante recheada com carne moída bem temperada|10.00|snack"
    ["Esfirra de Queijo"]="Massa leve com recheio de queijo derretido|7.00|snack"
    ["Tapioca com Queijo e Presunto"]="Tapioca recheada com queijo derretido e presunto|12.00|snack"
    ["Açaí na Tigela"]="Açaí batido com frutas e granola para uma opção mais saudável|20.00|snack"
